...
for i in input_lines:
    ...
    if cardinal_directions_dict.get(operation, ""):
        position = (
            position[0] + cardinal_directions_dict[operation][0] * value,
            position[1] + cardinal_directions_dict[operation][1] * value,
        )
    if operation == "F":
        position = (
...
for i in input_lines:
    ...
    if cardinal_directions_dict.get(operation, ""):
        waypoint = (
            waypoint[0] + cardinal_directions_dict[operation][0] * value,
